<nav class="bg-gray-800/50" aria-label="Global">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <x-nav-link href="/services" :current="request()->is('services')">Services</x-nav-link>
        ...
        <el-disclosure id="mobile-menu" hidden class="block md:hidden">
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                <!-- Current: "bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
                <x-nav-link style="display: block" href="/" :current="request()->is('/')">Home</x-nav-link>
                <x-nav-link style="display: block" href="/services" :current="request()->is('services')">Services</x-nav-link>
                <x-nav-link style="display: block" href="/about" :current="request()->is('about')">About</x-nav-link>
                <x-nav-link style="display: block" href="/contact" :current="request()->is('contact')">Contact</x-nav-link>
            </div>
